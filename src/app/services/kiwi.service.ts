...
async postData( url = this.apiUrl, data = myObject) {
  ...
  rastiMaziausiaKaina(dataStructure: any){
    ...
    console.log(dataStructure[3]);
    console.log(dataStructure[113]);
    ...
    console.log("maziausia kaina: "+ lowestPrice + "indeksas: "+itemIndex);
  ...
  surinktiDuomenis(index: number, dataStructure: any){
    ...
    console.log("Gautas atsakymas: " + this.resultDeparture + this.resultArrival + this.resultPrice + this.resultLink);
    // this.main.returnItems(this.resultDeparture, this.resultArrival, this.resultPrice, this.resultLink);
  }
  returnItems(
    departure: string,
    arrival: string,
    ...
    departure = this.resultDeparture;
    arrival = this.resultArrival;
